      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <select
            ...
            style={{
              background: '#26232b', border: '1px solid #38343f', borderRadius: 8,
              color: '#a8a3b0', padding: '8px 12px', fontSize: 13,
              fontFamily: 'Montserrat, sans-serif', cursor: 'pointer', outline: 'none', height: 36,
            }}
          >
        ...
        {['ALL', ...ALL_STATUSES].map((s) => (
          <button
            ...
            style={{
              ...
              borderBottom: `2px solid ${filter === s ? '#8b6dd6' : 'transparent'}`,
              color: filter === s ? '#8b6dd6' : '#a8a3b0',
          ...
          >
            ...
            {counts[s] > 0 && (
              <span style={{
                ...
                background: filter === s ? 'rgba(139, 109, 214, 0.2)' : 'rgba(56, 52, 63, 0.8)',
                color: filter === s ? '#8b6dd6' : '#6b6575',
              }}>
                {counts[s]}
              </span>
            )}
      ...
      {filtered.length === 0 ? (
        <div className="card" style={{ padding: 40, textAlign: 'center' }}>
          ...
          <div className="text-muted" style={{ fontSize: 13 }}>
            {search ? `No applications match "${search}"` : 'The goblin awaits your first application.'}
          </div>
        </div>
      ) : (
